...
import {Button, Desa, Gap, Header, RadioButton, TextInput} from '../../components';
...
const memoKecamatan = useMemo(()=>{
  ...
  const memoDesa = useMemo(()=>{
      return  <Desa label="Kelurahan/Desa"
            value={form.desa}
            datax={dataPullDesa}
...
const bsubmit = useMemo(()=>{
 ...
 console.log('formAlamat',formAlamat)
 console.log('formNIk',formNIk)
  return (<Button
            text="Submit"
            color="#0EA137"
            textColor="#F9F9F9"
